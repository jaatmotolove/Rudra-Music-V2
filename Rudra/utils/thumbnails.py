...
async def get_thumb(videoid, chat_id):
    ...
    try:
        ...
        bg = Image.open(f"Rudra/assets/bg.png")
        ...
        font = ImageFont.truetype("Rudra/assets/font2.ttf", 45)
        ImageFont.truetype("Rudra/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Rudra/assets/font2.ttf", 30)
        ImageFont.truetype("Rudra/assets/font.ttf", 30)
